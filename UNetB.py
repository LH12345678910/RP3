...
model = unet(drop=0.0734, n_filters=16, filter_size=3, pool_size=2, stride=2, output_channels=3)
...
model.compile(optimizer=tf.keras.optimizers.legacy.Adam(learning_rate=0.0014,beta_1=0.7085,beta_2=0.8602), loss=combined_loss,
              metrics=[DL1,
                       DL2,
                       DL3,
